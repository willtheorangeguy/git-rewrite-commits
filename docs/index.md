...
![git-rewrite-commits terminal output](./images/git-rewrite-commits.png)
...
> **See [QUICK_START.md](quickstart.md) for detailed setup guide**
...
If you discover any bugs, please create a [GitHub issue](https://github.com/f/git-rewrite-commits/issues).
